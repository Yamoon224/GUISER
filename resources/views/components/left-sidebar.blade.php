<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="{{ asset('public/logo/guiser.svg') }}" alt="" width="60" height="60" /></a>
            <strong><a href="index.html"><img src="{{ asset('public/logo/favicon.ico') }}" alt=""width="60" height="60" /></a></strong>
        </div>
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li id="removable">
                        <a href="{{ route('logout') }}" aria-expanded="false"><span class="educate-icon educate-pages icon-wrap"></span> <span class="mini-click-non">@lang('locale.logout')</span></a>
                    </li>                    
                </ul>
            </nav>
        </div>
